...
urlpatterns = [
                  ...
                  # 
                  path('get_all_positions/', company_views.all_positions_in_company_views,
                       name="all_positions_in_company"),
                  # 
                  path('choose_position/<int:position_id>/', company_views.choose_position,

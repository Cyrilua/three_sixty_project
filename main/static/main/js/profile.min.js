...
success:function(a){0<a.notificationsCount.polls?(u.text(a.notificationsCount.polls),u.removeClass("hide")):u.addClass("hide");0<a.notificationsCount.results?(v.text(a.notificationsCount.results),v.removeClass("hide")):v.addClass("hide");0<a.notificationsCount.invites?(w.text(a.notificationsCount.invites),w.removeClass("hide")):w.addClass("hide");a.newElems&&(z.removeClass("hide"),$(".notifications").prepend(a.content))},error:function(){}})},2E4);l.on("click",".notification__open",function(){x($(this).parent().parent()[0],

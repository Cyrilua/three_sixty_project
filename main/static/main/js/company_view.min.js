...
f.prepend(r("position",a,d));b.remove();0===c.children(".position").length&&c.children(".empty").removeClass("hide");h.remove()},error:function(){}})});l.on("click","#removeRole",function(){var b=$(this).parent().parent(),a=b.attr("data-role");if("boss"===a)Snackbar.show({text:"\u041d\u0435\u043b\u044c\u0437\u044f \u0443\u0434\u0430\u043b\u0438\u0442\u044c \u0440\u043e\u043b\u044c \u0431\u043e\u0441\u0441\u0430",textColor:"#ff1841",showAction:!1,duration:4E3,customClass:"custom center"});else{var d=
...
b.remove();0===d.children(".user__role").length&&d.children(".empty").removeClass("hide");g.remove()},error:function(){}})}});l.on("click","#edit",function(b){var a=$(this).closest(".user");a.hasClass("user--view")?(b=a[0].getBoundingClientRect(),$(".user--edit").removeClass("user--edit").addClass("user--view"),a.removeClass("user--view").addClass("user--edit"),a=a[0].getBoundingClientRect(),window.scrollBy(0,-(b.y-a.y))):a.hasClass("user--edit")&&a.removeClass("user--edit").addClass("user--view")});

...
u.empty().prepend(e.content)},complete:function(e,f){u.removeClass("loading");d||c.prop({disabled:!1});"error"===f&&Snackbar.show({text:"\u041f\u0440\u043e\u0438\u0437\u043e\u0448\u043b\u0430 \u043e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0435 \u0434\u0430\u043d\u043d\u044b\u0445.",textColor:"#ff0000",customClass:"custom center no-animation",showAction:!1,duration:3E3})},error:function(){}})}var k=$("body"),m=$('input[name="csrfmiddlewaretoken"]').val(),
u=$(".content__body"),n=[],p=[],t;k.on("click","#newPoll",function(a){});k.on("input",".search",function(a){a=$(".active-sort").attr("data-category");var b=$(this).val();w(a,a,b)});k.on("click",".category",function(a){a=$(".active-sort").attr("data-category");var b=$(this).attr("data-category");a!==b&&w(a,b)});window.onbeforeunload=function(){v(p);v(n)};window.onunload=function(){};k.on("click","#removeTeam",function(a){var b=$(this).parent(),d=b.children(".team__info").children(".team__name").children(".team__name").text();

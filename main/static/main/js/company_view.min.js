...
b=document.createElement("div");b.classList.add("item__line");a.prepend(b);a.prepend(d);return a}function v(b){for(var a=0;a<b.length;a++)b[a].finish||$.ajax(b[a].request)}function w(b,a,d){var c=$(".search");$.ajax({url:"load/",type:"get",data:{category:a,search:d},beforeSend:function(e){t&&t.abort();t=e;u.addClass("loading");$(".active-sort[data-category="+b+"]").removeClass("active-sort");$(".category[data-category="+a+"]").addClass("active-sort");b!==a&&c.prop({disabled:!0})},success:function(e){u.empty().prepend(e.content);
"teams"===a?$(".search").attr({placeholder:"\u041f\u043e\u0438\u0441\u043a \u043f\u043e \u043a\u043e\u043c\u0430\u043d\u0434\u0430\u043c..."}):"users"===a&&$(".search").attr({placeholder:"\u041f\u043e\u0438\u0441\u043a \u043f\u043e \u0443\u0447\u0430\u0441\u0442\u043d\u0438\u043a\u0430\u043c..."})},complete:function(e,f){b!==a&&c.prop({disabled:!1});u.removeClass("loading");"error"===f&&Snackbar.show({text:"\u041f\u0440\u043e\u0438\u0437\u043e\u0448\u043b\u0430 \u043e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0435 \u0434\u0430\u043d\u043d\u044b\u0445.",
textColor:"#ff0000",customClass:"custom center no-animation",showAction:!1,duration:3E3})},error:function(){$(".active-sort[data-category="+a+"]").removeClass("active-sort");$(".category[data-category="+b+"]").addClass("active-sort")}})}var l=$("body"),m=$('input[name="csrfmiddlewaretoken"]').val(),u=$(".content__body"),n=[],p=[],t;l.on("input",".search",function(b){b=$(".active-sort").attr("data-category");var a=$(this).val();w(b,b,a)});l.on("click",".category",function(b){b=$(".active-sort").attr("data-category");
var a=$(this).attr("data-category");if(b!==a){var d=$(".search");d.val("");d=d.val();w(b,a,d)}});window.onbeforeunload=function(){v(p);v(n)};window.onunload=function(){};l.on("click","#removeTeam",function(b){var a=$(this).parent(),d=a.children(".team__info").children(".team__name").children(".team__name").text();b=a.attr("data-team-id");var c;$.ajax({url:"team/"+b+"/remove/",type:"post",data:{csrfmiddlewaretoken:m},beforeSend:function(e,f){if(!n[c]){c=n.length;e.abort();n.push({request:f,finish:!1});
...
complete:function(){n[c].finish=!0},error:function(){a.removeClass("hide");Snackbar.show({text:'\u041f\u0440\u043e\u0438\u0437\u043e\u0448\u043b\u0430 \u043e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0443\u0434\u0430\u043b\u0435\u043d\u0438\u0438 "'+d+'"',textColor:"#ff0000",customClass:"custom no-animation",showAction:!1,duration:3E3})}})});l.on("click","#dismiss",function(b){var a=$(this).parent().parent().parent().parent(),d=a.children(".user__view").children(".info").children(".info__top").children(".user-href").text();
b=a.attr("data-real-id");var c;$.ajax({url:"user/"+b+"/dismiss/",type:"post",data:{csrfmiddlewaretoken:m},beforeSend:function(e,f){if(!p[c]){c=p.length;e.abort();p.push({request:f,finish:!1});a.addClass("hide");var g=setTimeout(function(){p[c].finish||$.ajax(f)},5E3);Snackbar.show({text:d+" \u0431\u044b\u043b \u0443\u0434\u0430\u043b\u0435\u043d \u0438\u0437 \u043a\u043e\u043c\u043f\u0430\u043d\u0438\u0438",customClass:"custom no-animation center",actionText:"\u041e\u0442\u043c\u0435\u043d\u0430",
actionTextColor:"yellow",width:"910px",pos:"bottom-center",duration:5E3,onActionClick:function(h){clearTimeout(g);$(h).remove();p[c].finish=!0;a.removeClass("hide")}})}},success:function(e){a.remove()},complete:function(){p[c].finish=!0},error:function(){a.removeClass("hide");Snackbar.show({text:"\u041f\u0440\u043e\u0438\u0437\u043e\u0448\u043b\u0430 \u043e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0443\u0434\u0430\u043b\u0435\u043d\u0438\u0438 "+d,textColor:"#ff0000",customClass:"custom no-animation",
showAction:!1,duration:3E3})}})});var x;l.on("click","._hint-up-click",function(){var b=$(this.closest("._hint-click")),a=$(b).children("._hint-down-click");b.toggleClass("active");a.toggle();x=$(this).parent()});$(window).on("mouseup",function(b){var a=x;"none"===$(a).children("._hint-down-click").css("display")||null!==b.target.closest("._hint-up-click")&&null!==b.target.closest(".position__add")&&$(a).children("._hint-up-click").hasClass("position__add")||null!==b.target.closest(".platform__add")&&
$(a).children("._hint-up-click").hasClass("platform__add")||null!==b.target.closest(".role__add")&&$(a).children("._hint-up-click").hasClass("role__add")||null!==b.target.closest("._hint-down-click")&&!b.target.classList.contains("item__block")||($(a).toggleClass("active"),$(a).children("._hint-down-click").toggle())});l.on("click","#addPlatform",function(b){var a=$(b.target).closest("._hint-click"),d=a.parent(),c=$(this).attr("data-name"),e=$(this).attr("data-id"),f=a.children("._hint-down-click").children("._hint-down-block").children(".menu"),
g=d.parent().parent().parent().parent(),h=g.children(".user__view").children(".info").children(".info__bottom").children(".positions-n-platforms"),q=h.children(".platform:last");g=g.attr("data-real-id");$.ajax({url:"user/"+g+"/edit/platform/"+e+"/add/",type:"post",data:{csrfmiddlewaretoken:m,namePlatform:c},success:function(B){0===d.children(".platform").length&&d.children(".empty").addClass("hide");$(a).before(k("platform",c,e));$(b.target).parent().remove();1>f.children(".menu__item").length&&$(a).addClass("hide");
1===q.length?q.after(k("platform",c,e,!1)):h.append(k("platform",c,e,!1))},error:function(){}})});l.on("click","#addPosition",function(b){var a=$(b.target).closest("._hint-click"),d=a.parent(),c=$(this).attr("data-name"),e=$(this).attr("data-id"),f=a.children("._hint-down-click").children("._hint-down-block").children(".menu"),g=d.parent().parent().parent().parent(),h=g.children(".user__view").children(".info").children(".info__bottom").children(".positions-n-platforms"),q=h.children(".position:last");
g=g.attr("data-real-id");$.ajax({url:"user/"+g+"/edit/position/"+e+"/add/",type:"post",data:{csrfmiddlewaretoken:m,namePosition:c},success:function(B){0===d.children(".position").length&&d.children(".empty").addClass("hide");$(a).before(k("position",c,e));$(b.target).parent().remove();1>f.children(".menu__item").length&&$(a).addClass("hide");1===q.length?q.after(k("position",c,e,!1)):h.prepend(k("position",c,e,!1))},error:function(){}})});l.on("click","#addRole",function(b){var a=$(b.target).closest("._hint-click"),
...
1>e.children(".menu__item").length&&$(a).addClass("hide");g.append(z(c))},error:function(){}})});l.on("click","#removePlatform",function(){var b=$(this).parent().parent(),a=b.attr("data-name"),d=b.attr("data-id"),c=b.parent(),e=c.children(".platform__substrate"),f=e.children("._hint-down-click").children("._hint-down-block").children(".menu"),g=c.parent().parent().parent().parent(),h=g.children(".user__view").children(".info").children(".info__bottom").children(".positions-n-platforms").children('.platform[data-id="'+
d+'"]');g=g.attr("data-real-id");$.ajax({url:"user/"+g+"/edit/platform/"+d+"/remove/",type:"post",data:{csrfmiddlewaretoken:m,namePlatform:a},success:function(q){0===f.children(".menu__item").length&&e.removeClass("hide");f.prepend(r("platform",a,d));b.remove();0===c.children(".platform").length&&c.children(".empty").removeClass("hide");h.remove()},error:function(){}})});l.on("click","#removePosition",function(){var b=$(this).parent().parent(),a=b.attr("data-name"),d=b.attr("data-id"),c=b.parent(),
e=c.children(".position__substrate"),f=e.children("._hint-down-click").children("._hint-down-block").children(".menu"),g=c.parent().parent().parent().parent(),h=g.children(".user__view").children(".info").children(".info__bottom").children(".positions-n-platforms").children('.position[data-id="'+d+'"]');g=g.attr("data-real-id");$.ajax({url:"user/"+g+"/edit/position/"+d+"/remove/",type:"post",data:{csrfmiddlewaretoken:m,namePosition:a},success:function(q){0===f.children(".menu__item").length&&e.removeClass("hide");
f.prepend(r("position",a,d));b.remove();0===c.children(".position").length&&c.children(".empty").removeClass("hide");h.remove()},error:function(){}})});l.on("click","#removeRole",function(){var b=$(this).parent().parent(),a=b.attr("data-role");if("boss"===a)Snackbar.show({text:"\u041d\u0435\u043b\u044c\u0437\u044f \u0443\u0434\u0430\u043b\u0438\u0442\u044c \u0440\u043e\u043b\u044c \u0431\u043e\u0441\u0441\u0430",textColor:"#ff1841",showAction:!1,duration:4E3,customClass:"custom"});else{var d=b.parent(),
c=d.children(".role__substrate"),e=c.children("._hint-down-click").children("._hint-down-block").children(".menu"),f=b.parent().parent().parent().parent().parent().parent(),g=f.children(".user__view").children(".info").children(".info__top").children(".user__role[data-role="+a+"]");f=f.attr("data-real-id");$.ajax({url:"user/"+f+"/edit/role/remove/",type:"post",data:{csrfmiddlewaretoken:m,roleName:a},success:function(h){0===e.children(".menu__item").length&&c.removeClass("hide");e.prepend(A(a));b.remove();
0===d.children(".user__role").length&&d.children(".empty").removeClass("hide");g.remove()},error:function(){}})}});l.on("click","#edit",function(b){var a=$(this).closest(".user");a.hasClass("user--view")?(b=a[0].getBoundingClientRect(),$(".user--edit").removeClass("user--edit").addClass("user--view"),a.removeClass("user--view").addClass("user--edit"),a=a[0].getBoundingClientRect(),window.scrollBy(0,-(b.y-a.y))):a.hasClass("user--edit")&&a.removeClass("user--edit").addClass("user--view")});$(".category[data-category=teams]").trigger("click")});

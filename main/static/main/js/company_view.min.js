...
t;k.on("input",".search",function(a){a=$(".active-sort").attr("data-category");var b=$(this).val();w(a,a,b)});k.on("click",".category",function(a){a=$(".active-sort").attr("data-category");var b=$(this).attr("data-category");a!==b&&w(a,b)});window.onbeforeunload=function(){v(n);v(p)};window.onunload=function(){};var p=[];k.on("click","#removeTeam",function(a){var b=$(this).parent(),d=b.children(".team__info").children(".team__name").children(".team__name").text();a=b.attr("data-team-id");var c;$.ajax({url:"team/"+
a+"/remove/",type:"post",data:{csrfmiddlewaretoken:m},beforeSend:function(e,f){p[c]||(c=p.length,e.abort(),p.push({request:f,finish:!1}),b.addClass("hide"),Snackbar.show({text:"\u041a\u043e\u043c\u0430\u043d\u0434\u0430 "+d+" \u0431\u044b\u043b\u0430 \u0443\u0434\u0430\u043b\u0435\u043d\u0430",customClass:"custom no-animation center",actionText:"\u041e\u0442\u043c\u0435\u043d\u0430",actionTextColor:"yellow",width:"910px",pos:"bottom-center",duration:5E3,onActionClick:function(g){p[c].finish=!0;$(g).remove();
b.removeClass("hide")},onClose:function(){p[c].finish||$.ajax(f)}}))},success:function(e){b.remove()},complete:function(){p[c].finish=!0},error:function(){b.removeClass("hide");Snackbar.show({text:"\u041f\u0440\u043e\u0438\u0437\u043e\u0448\u043b\u0430 \u043e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0432\u044b\u0445\u043e\u0434\u0435 \u0432o \u043a\u043e\u043c\u0430\u043d\u0434\u044b.",textColor:"#ff0000",customClass:"custom no-animation",showAction:!1,duration:3E3})}})});var n=[];k.on("click",
...
f=b.children("._hint-down-click").children("._hint-down-block").children(".menu"),g=d.parent().parent().parent().parent(),l=g.children(".user__view").children(".info").children(".info__bottom").children(".positions-n-platforms"),q=l.children(".platform:last");g=g.attr("data-real-id");$.ajax({url:"user/"+g+"/edit/platform/"+e+"/add/",type:"post",data:{csrfmiddlewaretoken:m,namePlatform:c},success:function(B){0===d.children(".platform").length&&d.children(".empty").addClass("hide");$(b).before(h("platform",
c,e));$(a.target).parent().remove();1>f.children(".menu__item").length&&$(b).addClass("hide");1===q.length?q.after(h("platform",c,e,!1)):l.append(h("platform",c,e,!1))},error:function(){}})});k.on("click","#addPosition",function(a){var b=$(a.target).closest("._hint-click"),d=b.parent(),c=$(this).attr("data-name"),e=$(this).attr("data-id"),f=b.children("._hint-down-click").children("._hint-down-block").children(".menu"),g=d.parent().parent().parent().parent(),l=g.children(".user__view").children(".info").children(".info__bottom").children(".positions-n-platforms"),
q=l.children(".position:last");g=g.attr("data-real-id");$.ajax({url:"user/"+g+"/edit/position/"+e+"/add/",type:"post",data:{csrfmiddlewaretoken:m,namePosition:c},success:function(B){0===d.children(".position").length&&d.children(".empty").addClass("hide");$(b).before(h("position",c,e));$(a.target).parent().remove();1>f.children(".menu__item").length&&$(b).addClass("hide");1===q.length?q.after(h("position",c,e,!1)):l.prepend(h("position",c,e,!1))},error:function(){}})});k.on("click","#addRole",function(a){var b=
...
$(a.target).parent().remove();1>e.children(".menu__item").length&&$(b).addClass("hide");g.append(z(c))},error:function(){}})});k.on("click","#removePlatform",function(){var a=$(this).parent().parent(),b=a.attr("data-name"),d=a.attr("data-id"),c=a.parent(),e=c.children(".platform__substrate"),f=e.children("._hint-down-click").children("._hint-down-block").children(".menu"),g=c.parent().parent().parent().parent(),l=g.children(".user__view").children(".info").children(".info__bottom").children(".positions-n-platforms").children('.platform[data-id="'+
d+'"]');g=g.attr("data-real-id");$.ajax({url:"user/"+g+"/edit/platform/"+d+"/remove/",type:"post",data:{csrfmiddlewaretoken:m,namePlatform:b},success:function(q){0===f.children(".menu__item").length&&e.removeClass("hide");f.prepend(r("platform",b,d));a.remove();0===c.children(".platform").length&&c.children(".empty").removeClass("hide");l.remove()},error:function(){}})});k.on("click","#removePosition",function(){var a=$(this).parent().parent(),b=a.attr("data-name"),d=a.attr("data-id"),c=a.parent(),
...
f.prepend(r("position",b,d));a.remove();0===c.children(".position").length&&c.children(".empty").removeClass("hide");l.remove()},error:function(){}})});k.on("click","#removeRole",function(){var a=$(this).parent().parent(),b=a.attr("data-role");if("boss"===b)Snackbar.show({text:"\u041d\u0435\u043b\u044c\u0437\u044f \u0443\u0434\u0430\u043b\u0438\u0442\u044c \u0440\u043e\u043b\u044c \u0431\u043e\u0441\u0441\u0430",textColor:"#ff1841",showAction:!1,duration:4E3,customClass:"custom"});else{var d=a.parent(),

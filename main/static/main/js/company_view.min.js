...
u.empty().prepend(e.content)},complete:function(e,f){u.removeClass("loading");d||c.prop({disabled:!1});"error"===f&&Snackbar.show({text:"\u041f\u0440\u043e\u0438\u0437\u043e\u0448\u043b\u0430 \u043e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0435 \u0434\u0430\u043d\u043d\u044b\u0445.",textColor:"#ff0000",customClass:"custom center no-animation",showAction:!1,duration:3E3})},error:function(){}})}var l=$("body"),m=$('input[name="csrfmiddlewaretoken"]').val(),
u=$(".content__body"),n=[],p=[],t;l.on("input",".search",function(a){a=$(".active-sort").attr("data-category");var b=$(this).val();w(a,a,b)});l.on("click",".category",function(a){a=$(".active-sort").attr("data-category");var b=$(this).attr("data-category");a!==b&&w(a,b)});window.onbeforeunload=function(){v(p);v(n)};window.onunload=function(){};l.on("click","#removeTeam",function(a){var b=$(this).parent(),d=b.children(".team__info").children(".team__name").children(".team__name").text();a=b.attr("data-team-id");
var c;$.ajax({url:"team/"+a+"/remove/",type:"post",data:{csrfmiddlewaretoken:m},beforeSend:function(e,f){if(!n[c]){c=n.length;e.abort();n.push({request:f,finish:!1});b.addClass("hide");var g=setTimeout(function(){n[c].finish||$.ajax(f)},5E3);Snackbar.show({text:'\u041a\u043e\u043c\u0430\u043d\u0434\u0430 "'+d+'" \u0431\u044b\u043b\u0430 \u0443\u0434\u0430\u043b\u0435\u043d\u0430',customClass:"custom no-animation center",actionText:"\u041e\u0442\u043c\u0435\u043d\u0430",actionTextColor:"yellow",width:"910px",
pos:"bottom-center",duration:5E3,onActionClick:function(h){clearTimeout(g);$(h).remove();n[c].finish=!0;b.removeClass("hide")}})}},success:function(e){b.remove()},complete:function(){n[c].finish=!0},error:function(){b.removeClass("hide");Snackbar.show({text:'\u041f\u0440\u043e\u0438\u0437\u043e\u0448\u043b\u0430 \u043e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0443\u0434\u0430\u043b\u0435\u043d\u0438\u0438 "'+d+'"',textColor:"#ff0000",customClass:"custom no-animation",showAction:!1,duration:3E3})}})});
l.on("click","#dismiss",function(a){var b=$(this).parent().parent().parent().parent(),d=b.children(".user__view").children(".info").children(".info__top").children(".user-href").text();a=b.attr("data-real-id");var c;$.ajax({url:"user/"+a+"/dismiss/",type:"post",data:{csrfmiddlewaretoken:m},beforeSend:function(e,f){if(!p[c]){c=p.length;e.abort();p.push({request:f,finish:!1});b.addClass("hide");var g=setTimeout(function(){p[c].finish||$.ajax(f)},5E3);Snackbar.show({text:d+" \u0431\u044b\u043b \u0443\u0434\u0430\u043b\u0435\u043d \u0438\u0437 \u043a\u043e\u043c\u043f\u0430\u043d\u0438\u0438",
customClass:"custom no-animation center",actionText:"\u041e\u0442\u043c\u0435\u043d\u0430",actionTextColor:"yellow",width:"910px",pos:"bottom-center",duration:5E3,onActionClick:function(h){clearTimeout(g);$(h).remove();p[c].finish=!0;b.removeClass("hide")}})}},success:function(e){b.remove()},complete:function(){p[c].finish=!0},error:function(){b.removeClass("hide");Snackbar.show({text:"\u041f\u0440\u043e\u0438\u0437\u043e\u0448\u043b\u0430 \u043e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0443\u0434\u0430\u043b\u0435\u043d\u0438\u0438 "+
d,textColor:"#ff0000",customClass:"custom no-animation",showAction:!1,duration:3E3})}})});var x;l.on("click","._hint-up-click",function(){var a=$(this.closest("._hint-click")),b=$(a).children("._hint-down-click");a.toggleClass("active");b.toggle();x=$(this).parent()});$(window).on("mouseup",function(a){var b=x;"none"===$(b).children("._hint-down-click").css("display")||null!==a.target.closest("._hint-up-click")&&null!==a.target.closest(".position__add")&&$(b).children("._hint-up-click").hasClass("position__add")||
...
$(a.target).parent().remove();1>e.children(".menu__item").length&&$(b).addClass("hide");g.append(z(c))},error:function(){}})});l.on("click","#removePlatform",function(){var a=$(this).parent().parent(),b=a.attr("data-name"),d=a.attr("data-id"),c=a.parent(),e=c.children(".platform__substrate"),f=e.children("._hint-down-click").children("._hint-down-block").children(".menu"),g=c.parent().parent().parent().parent(),h=g.children(".user__view").children(".info").children(".info__bottom").children(".positions-n-platforms").children('.platform[data-id="'+
d+'"]');g=g.attr("data-real-id");$.ajax({url:"user/"+g+"/edit/platform/"+d+"/remove/",type:"post",data:{csrfmiddlewaretoken:m,namePlatform:b},success:function(q){0===f.children(".menu__item").length&&e.removeClass("hide");f.prepend(r("platform",b,d));a.remove();0===c.children(".platform").length&&c.children(".empty").removeClass("hide");h.remove()},error:function(){}})});l.on("click","#removePosition",function(){var a=$(this).parent().parent(),b=a.attr("data-name"),d=a.attr("data-id"),c=a.parent(),
...
f.prepend(r("position",b,d));a.remove();0===c.children(".position").length&&c.children(".empty").removeClass("hide");h.remove()},error:function(){}})});l.on("click","#removeRole",function(){var a=$(this).parent().parent(),b=a.attr("data-role");if("boss"===b)Snackbar.show({text:"\u041d\u0435\u043b\u044c\u0437\u044f \u0443\u0434\u0430\u043b\u0438\u0442\u044c \u0440\u043e\u043b\u044c \u0431\u043e\u0441\u0441\u0430",textColor:"#ff1841",showAction:!1,duration:4E3,customClass:"custom"});else{var d=a.parent(),

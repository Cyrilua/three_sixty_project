...
textColor:"#ff0000",customClass:"custom center no-animation",showAction:!1,duration:3E3})},error:function(){$(".active-sort[data-category="+a+"]").removeClass("active-sort");$(".category[data-category="+b+"]").addClass("active-sort")}})}var k=$("body"),m=$('input[name="csrfmiddlewaretoken"]').val(),u=$(".content__body"),n=[],p=[],t;k.on("input",".search",function(b){b=$(".active-sort").attr("data-category");var a=$(this).val();w(b,b,a)});k.on("click",".category",function(b){b=$(".active-sort").attr("data-category");
var a=$(this).attr("data-category");if(b!==a){var d=$(".search");d.val("");d=d.val();w(b,a,d)}});window.onbeforeunload=function(){v(p);v(n)};window.onunload=function(){};k.on("click","#removeTeam",function(b){var a=$(this).parent(),d=a.children(".team__info").children(".team__name").children(".team__name").text();b=a.attr("data-team-id");var c;$.ajax({url:"team/"+b+"/remove/",type:"post",data:{csrfmiddlewaretoken:m},beforeSend:function(e,f){if(!n[c]){c=n.length;e.abort();n.push({request:f,finish:!1});
...
b.remove();0===d.children(".user__role").length&&d.children(".empty").removeClass("hide");g.remove()},error:function(){}})}});k.on("click","#edit",function(b){var a=$(this).closest(".user");a.hasClass("user--view")?(b=a[0].getBoundingClientRect(),$(".user--edit").removeClass("user--edit").addClass("user--view"),a.removeClass("user--view").addClass("user--edit"),a=a[0].getBoundingClientRect(),window.scrollBy(0,-(b.y-a.y))):a.hasClass("user--edit")&&a.removeClass("user--edit").addClass("user--view")});

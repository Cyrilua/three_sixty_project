...
$.ajax({url:"register/"+e,type:"post",data:{surname:l.val(),name:d.val(),email:f.val(),csrfmiddlewaretoken:c,host:location.hostname},beforeSend:function(){$(".step-2").addClass("hide");$(".step-3").removeClass("hide")},statusCode:{400:function(){throw Error("Error 400 - \u041d\u0435\u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u044b\u0439 \u0437\u0430\u043f\u0440\u043e\u0441");},403:function(){throw Error("Error 403 - \u0414\u043e\u0441\u0442\u0443\u043f \u0437\u0430\u043f\u0440\u0435\u0449\u0451\u043d");
},404:function(){throw Error("Error 404 - \u0421\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u0430");},500:function(){throw Error("Error 500 - \u0412\u043d\u0443\u0442\u0440\u0435\u043d\u043d\u044f\u044f \u043e\u0448\u0438\u0431\u043a\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0430");}},error:function(){throw Error("\u0427\u0442\u043e - \u0442\u043e \u043f\u043e\u0448\u043b\u043e \u043d\u0435 \u0442\u0430\u043a :(");}})});a.on("click","#back-2",function(e){e.preventDefault();
$(".step-3").addClass("hide");$(".step-2").removeClass("hide")});a.on("focus",".input-field",function(){for(var e in m){var r=$(this)[0].name;if(e===r)if(m[e])$(this).parent().children(".popup").css({display:"block",opacity:0}).stop().animate({opacity:1},300);else break}});a.on("focusout",".input-field",function(){$(this).parent().children(".popup").stop().animate({opacity:0},300,function(){$(this).css({display:"none"})})});a.on("input","#id_username",function(){var e=$(this);ajaxForUsername(e,c,
k,m,a,300)});a.on("input","#id_password1",function(){var e=$(this);ajaxForPassword1(e,c,k,m,a,300)});a.on("input","#id_password2",function(){var e=$(this);ajaxForPassword2(e,c,k,m,a,300)});a.on("input","#id_email",function(){var e=$(this);ajaxForEmail(e,c,k,m,a,300)});a.on("input","#id_name",function(){var e=$(this);ajaxForName(e,c,k,m,a,300)});a.on("input","#id_surname",function(){var e=$(this);ajaxForSurname(e,c,k,m,a,300)});a.on("input","#id_patronymic",function(){var e=$(this);ajaxForPatronymic(e,
c,k,m,a,300)});a.on("input","#id_birthday",function(){var e=$(this);ajaxForBirthday(e,c,k,m,a,300)});a.on("input","#code",function(){var e=$(this);k.code=0<e.val().length;checkBtnDone(k)});a.on("mouseup","#btn-register",function(e){var r=$(this).attr("data-part-url");$.ajax({url:"register/"+r,type:"post",data:{code:q.val(),email:f.val(),csrfmiddlewaretoken:c},success:function(p){chooseValidationColor(e.target,p.resultStatus);"success"===p.resultStatus?(e.target.type="submit",$(e.target).trigger("click")):
"error"===p.resultStatus&&(k.code=!1,m.code=!0,chooseValidationColor(q[0],p.resultStatus),showErrors(a,q,p.listErrors,300),q.focus(),checkBtnDone(k))},statusCode:{400:function(){throw Error("Error 400 - \u041d\u0435\u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u044b\u0439 \u0437\u0430\u043f\u0440\u043e\u0441");},403:function(){throw Error("Error 403 - \u0414\u043e\u0441\u0442\u0443\u043f \u0437\u0430\u043f\u0440\u0435\u0449\u0451\u043d");},404:function(){throw Error("Error 404 - \u0421\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u0430");
},500:function(){throw Error("Error 500 - \u0412\u043d\u0443\u0442\u0440\u0435\u043d\u043d\u044f\u044f \u043e\u0448\u0438\u0431\u043a\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0430");}},error:function(){throw Error("\u0427\u0442\u043e - \u0442\u043e \u043f\u043e\u0448\u043b\u043e \u043d\u0435 \u0442\u0430\u043a :(");}})})});function formatValue(a){a=a[0];if(""!==a.value){var c=a.selectionStart;a.value=a.value[0].toUpperCase()+a.value.slice(1).toLowerCase();a.selectionStart=a.selectionEnd=c}}

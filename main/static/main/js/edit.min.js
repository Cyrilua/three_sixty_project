...
document.createElement("span");d.classList.add("popup_message-text");d.textContent=b[c];g.append(d)}a.css({display:"block",opacity:0}).stop().animate({opacity:1},300)}else l(a)}function y(a,b){b=b.prop("id");if("name"===b||"surname"===b||"patronymic"===b)!(e.name||e.surname||e.patronymic)||f.name||f.surname||f.patronymic?a.prop({disabled:!0}):a.prop({disabled:!1});else if("birthdate"===b)e.birthdate?a.prop({disabled:!1}):a.prop({disabled:!0});else if("email"===b||"password_for_email"===b)e.email&&
...
"email_code"===b&&(d=$(".setting__email"),k=$(d[1]),d=$(d[0]));if("name"===b)P.val(c.name),Q.val(c.surname),R.val(c.patronymic),z.text(c.name+" "+c.surname),M(),k.text(c.surname+" "+c.name+" "+c.patronymic),d.text(c.surname+" "+c.name+" "+c.patronymic),$(".head-menu-name").text(c.name+" "+c.surname),e.name=!1,e.surname=!1,e.patronymic=!1,f.name=!1,f.surname=!1,f.patronymic=!1;else if("birthdate"===b)x.val(c.birthdate.date),k.text(""+c.birthdate.text),d.text(""+c.birthdate.text),e.birthdate=!1,f.birthdate=
!1;else if("email"===b)v.val(""),e.password_for_email=!1,f.password_for_email=!1,"error"===c.resultStatus?(e.email=!0,f.email=!1,f.password_for_email=!0,p(v[0],c.resultStatus,c.listErrors.password_for_email),n(v,c.listErrors.password_for_email),v.focus()):"success"===c.resultStatus&&(e.email=!1,f.email=!1,sessionStorage.setItem("new_email",B.val()),B.val(""),C.toggleClass("hide"));else if("email_code"===b)"error"===c.resultStatus?(f.email_code=!0,p(D[0],c.resultStatus,c.listErrors),n(D,c.listErrors),
v.focus()):"success"===c.resultStatus&&(k.text(""+c.email),d.text(""+c.email),sessionStorage.removeItem("new_email"),C.toggleClass("hide"));else if("username"===b)B.val(c.username),k.text(""+c.username),d.text(""+c.username),e.username=!1,f.username=!1;else if("password"===b)u.val(""),E.val(""),t.val(""),t.prop({disabled:!0}),e.password_old=!1,e.password1=!1,e.password2=!1,f.password_old=!1,f.password1=!1,f.password2=!1,"error"===c.resultStatus&&(f.password_old=!0,p(u[0],c.resultStatus,c.listErrors.old_password),
n(u,c.listErrors.old_password),u.focus());else throw Error("Unexpected argument values");},statusCode:{400:function(){throw Error("Error 400 - \u041d\u0435\u043a\u043e\u0440\u0440\u0435\u043a\u0442\u043d\u044b\u0439 \u0437\u0430\u043f\u0440\u043e\u0441");},403:function(){throw Error("Error 403 - \u0414\u043e\u0441\u0442\u0443\u043f \u0437\u0430\u043f\u0440\u0435\u0449\u0451\u043d");},404:function(){throw Error("Error 404 - \u0421\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u0430");

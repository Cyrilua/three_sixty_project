$(function(){function g(){var b=l(),c=$(".results");console.log(b);$.ajax({url:"save_as/",type:"post",data:{csrfmiddlewaretoken:m,template:b},beforeSend:function(){c.addClass("disabled")},success:function(){Snackbar.show({text:"\u0428\u0430\u0431\u043b\u043e\u043d \u0443\u0441\u043f\u0435\u0448\u043d\u043e \u0441\u043e\u0437\u0434\u0430\u043d",showAction:!0,duration:3E3,actionText:"\u0417\u0430\u043a\u0440\u044b\u0442\u044c",actionTextColor:"green",customClass:"custom center"})},error:function(){Snackbar.show({text:"\u041e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u0438\u0438 \u0448\u0430\u0431\u043b\u043e\u043d\u0430",
showAction:!0,duration:3E3,actionText:"\u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u044c",actionTextColor:"red",customClass:"custom center",onActionClick:function(d){$(d).animate({opacity:0},200,function(){g()})}})},complete:function(){c.removeClass("disabled")}})}function l(){var b=$(".poll"),c=b.children(".questions").children(".question"),d={name:b.children(".poll__name").text(),description:b.children(".poll_description").text(),questions:[],color:b.attr("data-poll-color"),countQuestion:c.length};

...
return d}var f=$("body"),h=$('input[name="csrfmiddlewaretoken"]').val(),p=$("#companyName").val().toString(),q=$("#companyDescription").val().replace(/[\r\n]/g,""),e=[];window.onbeforeunload=function(){for(var b=0;b<e.length;b++)e[b].finish||$.ajax(e[b].request)};window.onunload=function(){};f.on("click","#copy",function(b){b=$("#href-invite");b.css({display:"block"}).select();document.execCommand("copy");b.css({display:"none"})});f.on("click","#positionRemove",function(b){var a=$(this).parent();
b=a.attr("data-position-id");var c=a.children(".item__text").text(),d;$.ajax({url:"position/"+b+"/remove/",type:"post",data:{csrfmiddlewaretoken:h},beforeSend:function(k,l){if(e[d])a.addClass("hide");else{d=e.length;k.abort();e.push({request:l,finish:!1});a.addClass("hide");var m=setTimeout(function(){e[d].finish||$.ajax(l)},5E3);Snackbar.show({text:'\u0414\u043e\u043b\u0436\u043d\u043e\u0441\u0442\u044c "'+c+'" \u0431\u044b\u043b\u0430 \u0443\u0434\u0430\u043b\u0435\u043d\u0430',customClass:"custom no-animation center",
actionText:"\u041e\u0442\u043c\u0435\u043d\u0430",actionTextColor:"yellow",width:"910px",pos:"bottom-center",duration:5E3,onActionClick:function(n){clearTimeout(m);$(n).remove();e[d].finish=!0;a.removeClass("hide")}})}},success:function(k){a.remove()},complete:function(){},error:function(){a.removeClass("hide");Snackbar.show({text:'\u041e\u0448\u0438\u0431\u043a\u0430 \u0443\u0434\u0430\u043b\u0435\u043d\u0438\u044f \u0434\u043e\u043b\u0436\u043d\u043e\u0441\u0442\u0438 "'+c+'"',textColor:"#ff0000",
customClass:"custom no-animation",showAction:!1,duration:3E3})}})});f.on("click","#platformRemove",function(b){var a=$(this).parent();b=a.attr("data-platform-id");var c=a.children(".item__text").text(),d;$.ajax({url:"platform/"+b+"/remove/",type:"post",data:{csrfmiddlewaretoken:h},beforeSend:function(k,l){if(e[d])a.addClass("hide");else{d=e.length;k.abort();e.push({request:l,finish:!1});a.addClass("hide");var m=setTimeout(function(){e[d].finish||$.ajax(l)},5E3);Snackbar.show({text:'\u041e\u0442\u0434\u0435\u043b "'+
c+'" \u0431\u044b\u043b\u0430 \u0443\u0434\u0430\u043b\u0435\u043d',customClass:"custom no-animation center",actionText:"\u041e\u0442\u043c\u0435\u043d\u0430",actionTextColor:"yellow",width:"910px",pos:"bottom-center",duration:5E3,onActionClick:function(n){clearTimeout(m);$(n).remove();e[d].finish=!0;a.removeClass("hide")}})}},success:function(k){a.remove()},complete:function(){},error:function(){a.removeClass("hide");Snackbar.show({text:'\u041e\u0448\u0438\u0431\u043a\u0430 \u0443\u0434\u0430\u043b\u0435\u043d\u0438\u044f \u043e\u0442\u0434\u0435\u043b\u0430 "'+
...
data:{name:a,description:c,csrfmiddlewaretoken:h},beforeSend:function(){content.addClass("disabled")},success:function(){p=a;q=c;$("#saveChanges").prop({disabled:!0});Snackbar.show({text:"\u0418\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u044b.",textColor:"#07bd00",customClass:"custom no-animation",showAction:!1,duration:3E3})},complete:function(){content.removeClass("disabled")},error:function(){Snackbar.show({text:"\u041f\u0440\u043e\u0438\u0437\u043e\u0448\u043b\u0430 \u043e\u0448\u0438\u0431\u043a\u0430 \u043f\u0440\u0438 \u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u0438\u0438.",

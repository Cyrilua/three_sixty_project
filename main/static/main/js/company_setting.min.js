...
customClass:"custom no-animation",showAction:!1,duration:3E3})}})});f.on("click","#platformRemove",function(b){var a=$(this).parent();b=a.attr("data-platform-id");var c=a.children(".item__text").text(),d;$.ajax({url:"position/"+b+"/remove/",type:"post",data:{csrfmiddlewaretoken:h},beforeSend:function(k,l){if(e[d])a.addClass("hide");else{d=e.length;k.abort();e.push({request:l,finish:!1});a.addClass("hide");var m=setTimeout(function(){e[d].finish||$.ajax(l)},5E3);Snackbar.show({text:'\u041e\u0442\u0434\u0435\u043b "'+
